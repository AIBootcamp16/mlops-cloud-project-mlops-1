...
PROJECT_ROOT = os.path.dirname(os.path.abspath(__file__))  # current file's directory
SRC_PATH = os.path.dirname(PROJECT_ROOT)                  # parent directory
if SRC_PATH not in sys.path:
    sys.path.insert(0, SRC_PATH)

print("SRC_PATH set to:", SRC_PATH)
...
df_feat["new_cases"] = targets.values
df_feat = add_time_features(df_feat, "date")
...
# uvicorn server:app --host 0.0.0.0 --port 5432
# curl "http://localhost:5432/date?date=2025-12-30"